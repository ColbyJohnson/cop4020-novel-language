...
public final class AnalyzerTests {
    ...
    private static final Environment.Type OBJECT_TYPE = new Environment.Type("ObjectType", "ObjectType", init(new Scope(null), scope -> {
        ...
        scope.defineFunction("method", "method", List.of(Environment.Type.ANY), Environment.Type.INTEGER, args -> Environment.NIL);
    }));
    ...
    private static Stream<Arguments> testMethod() {
        return Stream.of(
                Arguments.of("Hello World",
                        ...
                        init(new Ast.Method("main", List.of(), List.of(), Optional.of("Integer"), List.of(
                                new Ast.Statement.Expression(init(new Ast.Expression.Function(Optional.empty(), "print", List.of(
        ...
        return Stream.of(
                Arguments.of("Valid Condition",
                        ...
                        new Ast.Statement.If(
                                ...
                                List.of(new Ast.Statement.Expression(
                                        init(new Ast.Expression.Function(Optional.empty(), "print", List.of(
                                                init(new Ast.Expression.Literal(BigInteger.ONE), ast -> ast.setType(Environment.Type.INTEGER))
                                        )), ast -> ast.setFunction(new Environment.Function("print", "System.out.println", List.of(Environment.Type.ANY), Environment.Type.NIL, args -> Environment.NIL))))
                                ),
                                List.of()
    ...
    private static Stream<Arguments> testFunctionExpression() {
        return Stream.of(
                Arguments.of("Function",
                        ...
                        init(new Ast.Expression.Function(Optional.empty(), "function", List.of()), ast -> ast.setFunction(new Environment.Function("function", "function", List.of(), Environment.Type.INTEGER, args -> Environment.NIL)))
                ),
                Arguments.of("Method",
                        // object.method()
                        ...
                        init(new Ast.Expression.Function(Optional.of(
                                init(new Ast.Expression.Access(Optional.empty(), "object"), ast -> ast.setVariable(new Environment.Variable("object", "object", OBJECT_TYPE, false, Environment.NIL)))
                        ), "method", List.of()), ast -> ast.setFunction(new Environment.Function("method", "method", List.of(Environment.Type.ANY), Environment.Type.INTEGER, args -> Environment.NIL)))
                )
        );
    }
